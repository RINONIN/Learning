...
%sm =[sigma,mu]
%Computes the Tiknonov regularized solution x_lambda.If the SVD
...
% Note that x_O cannot be used if A is underdetermined and L ~= L.
% If lambda is a vector��then x_lambda is a matrix such that
%x_lambda =[ x_lambda(1) , x_lambda( 2),... ] .
% The solution norm ( standard-form case) or seminorm
%( general-form case) and the residual norm are returned in eta and rho.
